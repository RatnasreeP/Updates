...
<body>
    ...
    <div id="div12">
        ...
        <div>
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowCommand="GridView2_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkbtn" runat="server" CommandName="edt" CommandArgument='<%# Eval("Empid") %>' Text="Edit"></asp:LinkButton>
                            <asp:LinkButton ID="lnkbtn2" runat="server" CommandName="delete" CommandArgument='<%# Eval("Empid") %>' Text="Delete"></asp:LinkButton>
                         </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
